  ...
  return (
    <div>
      ...
      <Typography style={{ textAlign: "justify", fontSize: 16, marginTop: 10 }}>
        When you make payment from our website, we collect the personal
        ...
        emails about our website and other updates.
      </Typography>
      <Typography
        style={{
          textAlign: "justify",
      ...
      <Typography style={{ textAlign: "justify", fontSize: 16, marginTop: 10 }}>
        ...
        return a payment, we imply that you consent to our collecting it and
      ...
      <Typography style={{ textAlign: "justify", fontSize: 16, marginTop: 10 }}>
        ...
        of your information, at anytime, by mailing us at collesmizo@gmail.com
      </Typography>
      <Typography
        style={{
          textAlign: "justify",
      ...
      <Typography style={{ textAlign: "justify", fontSize: 16, marginTop: 10 }}>
        If our product is acquired or merged with another company, your
      ...
      <Typography style={{ textAlign: "justify", fontSize: 16, marginTop: 10 }}>
        ...
        information contact our development team at devus@hereus.in
      </Typography>
    </div>
  );
};
